...
class List {
  ...
  //----------------------------------------------------------------------
  //      Peeks at the first "item" from the front of a sorted list.
  // 
  // Returns:
  //	key of first item, null if nothing on the list.
  //----------------------------------------------------------------------

  public Integer sortedPeek() {
    Integer i;

    if (isEmpty()) 
	return null;

    i = new Integer((int)first.getKey()); 
